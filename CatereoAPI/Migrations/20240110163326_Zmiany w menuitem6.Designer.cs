...
namespace CatereoAPI.Migrations
{
    ...
    [Migration("20240110163326_Zmiany w menuitem6")]
    partial class Zmianywmenuitem6
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CatereoAPI.Data.MenuItemCategory", b =>
                {
                    b.Property<int>("MenuItemId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CatereoAPI.Data.MenuItemIngredient", b =>
                {
                    b.Property<int>("MenuItemId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CatereoAPI.Data.MenuItemCategory", b =>
                {
                    b.HasOne("CatereoAPI.Data.CATEGORY", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("CatereoAPI.Data.MenuItemIngredient", b =>
                {
                    b.HasOne("CatereoAPI.Data.Ingredient", "Ingredient")
                        .WithMany()
